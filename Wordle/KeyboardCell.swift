  ...
  @objc private func didTapString() {
    ...
    // ...
      UIView.animate(withDuration: 0.10,
                     animations: {self.labelContainerView.transform = CGAffineTransform(scaleX: 0.90, y: 0.90)},completion: { _ in UIView.animate(withDuration: 0.10){self.labelContainerView.transform = .identity}
      })
